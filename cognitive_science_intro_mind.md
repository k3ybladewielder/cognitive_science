...
A psicologia foi a primeira disciplina em que foram adotados métodos científicos exclusivamente para estudar fenômenos mentais. Os primeiros psicólgos realizavam experimentos laboratoriais para catalogar ideias mentais e investigar as várias capacidades mentais, como **visão** e **memória**. Eles aplicam métodos científicos direcionados à **mente e comportamento**, para tentar entender não apenas fenomenos internos como **pensamentos**, mas também comportamentos externos (outputs), que esses fenômenos internos podem gerar.

O **método científico** é a forma de obter conhecimentos válidos sobre o mundo. Começando com uma hipótese sobre como o fenômeno funciona, depois o design do experimento para verificar a validade da hipótese. Em experimentos, fazemos observações sobre **situações controladas**.

O campo da psicologia é amplo, abarcando diversas subdisciplinas. E cada uma delas tem suas orientações teóricas únicas, cada uma delas fundamenta o que a mente é sob suas próprias teorias. A exemplo, temos os voluntaristas e estruturalistas, funcionalismo, gestaltistas, psicanálise, behavioristas, etc.
